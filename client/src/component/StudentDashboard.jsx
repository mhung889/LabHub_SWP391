          ...
          <Row className="g-4 mb-4">
            ...
            <Col md={12} lg={8}>
              <div className="custom-card p-4 d-flex flex-column align-items-center justify-content-center text-center">
                <p className="text-secondary small mb-4">Thứ Hai, ngày 26 tháng 10 năm 2023 - 09:00</p>
                
                <Button 
                  variant="primary" 
                  className="main-btn bg-primary-custom border-0 px-5 d-flex align-items-center gap-3"
                >
                  <span className="material-symbols-outlined fs-4">photo_camera</span>
                  Điểm danh bằng khuôn mặt
                </Button>

                <p className="text-secondary small mt-4 mb-0">Nhấn nút để điểm danh cho lớp học tiếp theo của bạn.</p>
              </div>
            </Col>
              ...
              <div className="custom-card p-4 d-flex flex-column justify-content-between">
                ...
                <div className="text-center my-3">
                  <div className="d-flex align-items-baseline justify-content-center">
                    <span className="display-4 fw-bold text-primary-custom">3</span>
                ...
                <div>
                  <div className="d-flex justify-content-between mb-2">
                    <small className="fw-bold text-dark">Số ngày nghỉ phép còn lại</small>
                    <small className="text-dark">75%</small>
                  </div>
                  {/* React Bootstrap ProgressBar */}
                  <ProgressBar now={75} variant="info" style={{ height: '8px', backgroundColor: '#e2e8f0' }} className="rounded-pill" />
                ...
                <div className="d-flex flex-column gap-3">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    <div className="icon-box bg-primary-light">
                      <span className="material-symbols-outlined text-primary-custom">calculate</span>
                    </div>
                    <div className="flex-grow-1">
                      <p className="fw-bold text-dark mb-0">Toán cao cấp</p>
                      <small className="text-secondary">10:00 - 11:30</small>
                    </div>
                    <span className="badge bg-success bg-opacity-10 text-success rounded-pill px-3 py-2">Đã điểm danh</span>
                  </div>
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <span className="badge bg-secondary bg-opacity-10 text-secondary rounded-pill px-3 py-2">Sắp tới</span>
                  </div>
                </div>
              </div>
            </Col>
            ...
            <Col md={12} lg={6}>
              <div className="custom-card p-4">
                ...
                <div className="d-flex flex-column gap-3">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    <div className="icon-box bg-primary-light">
                      <span className="material-symbols-outlined text-primary-custom">login</span>
                    </div>
                    <div className="flex-grow-1">
                      <p className="fw-bold text-dark mb-0 fs-6">Đã điểm danh môn Toán cao cấp</p>
                      <small className="text-secondary" style={{ fontSize: '0.75rem' }}>Hôm nay, 09:58</small>
                    </div>
                  </div>
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div className="flex-grow-1">
                      <p className="fw-bold text-dark mb-0 fs-6">Đã điểm danh môn Lịch sử nghệ thuật</p>
                      <small className="text-secondary" style={{ fontSize: '0.75rem' }}>Hôm qua, 13:02</small>
                    </div>
                  </div>
                  ...
                  <div className="d-flex align-items-center gap-3">
                    <div className="icon-box bg-danger bg-opacity-10">
                      <span className="material-symbols-outlined text-danger">calendar_month</span>
                    </div>
                    <div className="flex-grow-1">
                      <p className="fw-bold text-dark mb-0 fs-6">Đã sử dụng một ngày nghỉ phép</p>
                      <small className="text-secondary" style={{ fontSize: '0.75rem' }}>3 ngày trước</small>
                    </div>
                  </div>
